                ...
                <div class="p-6 text-gray-900 space-y-4">
                    ...
                    <div class="flex flex-col gap-3 sm:flex-row">
                        ...
                        <a
                            ...
                            class="inline-flex items-center justify-center rounded-md border border-emerald-200 bg-white px-4 py-2 text-sm font-semibold text-emerald-800 transition hover:bg-emerald-50 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2"
                        >
                            {{ __('Buscar ligas') }}
                        </a>
