...
class KnockoutPredictionFlowTest extends TestCase
{
    ...
    public function test_knockout_match_prediction_requires_predicted_qualified_team(): void
    {
    ...
    public function test_bulk_store_requires_valid_qualified_team_for_knockout_match(): void
    {
        $user = User::factory()->create();
        $match = TournamentMatch::factory()->state([
            'stage' => 'semi_final',
